...
object SparkContext extends Logging {
  ...
  private[spark] val SPARK_JOB_PROXY_USER = "spark.job.user"
  private[spark] val SPARK_JOB_PROXY_TOKEN = "spark.job.proxy.token"
  private[spark] val SPARK_JOB_PROXY_TOKEN_DELIMITER = ","
