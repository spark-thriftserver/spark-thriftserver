...
object BuildCommons {
  ...
  val sqlProjects@Seq(catalyst, sql, hive, hiveThriftServer, service, jdbc, tokenProviderKafka010, sqlKafka010, avro) = Seq(
    "catalyst", "sql", "hive", "hive-thriftserver", "service", "jdbc", "token-provider-kafka-0-10", "sql-kafka-0-10", "avro"
...
object SparkBuild extends PomBuild {
  ...
  val mimaProjects = allProjects.filterNot { x =>
    Seq(
      spark, hive, hiveThriftServer, service, jdbc, catalyst, repl, networkCommon, networkShuffle, networkYarn,
...
object SparkParallelTestGrouping {
  ...
  private val testsWhichShouldRunInTheirOwnDedicatedJvm = Set(
    ...
    "org.apache.spark.sql.jdbc.ThriftServerWithSparkContextSuite",
