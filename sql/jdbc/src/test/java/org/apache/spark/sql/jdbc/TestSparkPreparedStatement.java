...
import org.apache.spark.sql.service.rpc.thrift.TOperationState;
...
public class TestSparkPreparedStatement {
    ...
    public void before() throws Exception {
        ...
        when(tGetOperationStatusResp.getOperationState())
            .thenReturn(TOperationState.FINISHED_STATE);
        ...
        when(client.ExecuteStatement(any(TExecuteStatementReq.class)))
            .thenReturn(tExecStatementResp);
    }
