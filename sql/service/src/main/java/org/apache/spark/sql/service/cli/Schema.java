...
public class Schema
    implements TBase<Schema, Schema._Fields>, java.io.Serializable, Cloneable, Comparable<Schema> {
  private static final TStruct STRUCT_DESC = new TStruct("Schema");

  private static final TField FIELD_SCHEMAS_FIELD_DESC =
      new TField("fieldSchemas", TType.LIST, (short)1);
  private static final TField PROPERTIES_FIELD_DESC =
      new TField("properties", TType.MAP, (short)2);
  ...
  static {
    ...
    tmpMap.put(_Fields.FIELD_SCHEMAS,
        new FieldMetaData("fieldSchemas",
            TFieldRequirementType.DEFAULT,
            new ListMetaData(TType.LIST, new StructMetaData(TType.STRUCT, FieldSchema.class))));
  ...
  public Schema(Schema other) {
    if (other.isSetFieldSchemas()) {
      List<FieldSchema> __this__fieldSchemas =
          new ArrayList<FieldSchema>(other.fieldSchemas.size());
  ...
  private static class SchemaStandardScheme extends StandardScheme<Schema> {
    ...
    public void write(TProtocol oprot, Schema struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.fieldSchemas != null) {
        ...
        {
          oprot.writeListBegin(new TList(TType.STRUCT, struct.fieldSchemas.size()));
      ...
      if (struct.properties != null) {
        ...
        {
          oprot.writeMapBegin(new TMap(TType.STRING, TType.STRING, struct.properties.size()));
  ...
  private static class SchemaTupleScheme extends TupleScheme<Schema> {
    ...
    @Override
    public void write(TProtocol prot, Schema struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(TProtocol prot, Schema struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(2);
      if (incoming.get(0)) {
        {
          TList _list305 = new TList(TType.STRUCT, iprot.readI32());
      ...
      if (incoming.get(1)) {
        {
          TMap _map308 = new TMap(TType.STRING, TType.STRING, iprot.readI32());
