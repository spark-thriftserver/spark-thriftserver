...
/**
 *    FastSparkDecimal is a mutable fast decimal object.  It is the base class for both the
 *    SparkDecimal and HiveDecimalWritable classes.  All fast* methods are protected so they
 *    cannot be accessed by clients of SparkDecimal and HiveDecimalWritable.  SparkDecimal ensures
 ...
 *
 *    The methods in this class are shells that pickup the member variables from FastSparkDecimal
 *    parameters and pass them as individual parameters to static methods in the FastSparkDecimalImpl
 *    class that do the real work.
 *
 *    NOTE: The rationale for fast decimal is in FastSparkDecimalImpl.
 */
public class FastSparkDecimal {

  /*
   * We use protected for the fields so the FastSparkDecimalImpl class can access them.  Other
   * classes including SparkDecimal should not access these fields directly.
   */

  // See FastSparkDecimalImpl for more details on these fields.
  ...
  protected FastSparkDecimal() {
    fastReset();
  }

  protected FastSparkDecimal(FastSparkDecimal fastDec) {
    this();
  ...
  protected FastSparkDecimal(int fastSignum, FastSparkDecimal fastDec) {
    this();
  ...
  protected FastSparkDecimal(long longValue) {
    this();
    FastSparkDecimalImpl.fastSetFromLong(longValue, this);
  }

  protected FastSparkDecimal(String string) {
    this();
    FastSparkDecimalImpl.fastSetFromString(string, false, this);
  }
  ...
  protected void fastSet(FastSparkDecimal fastDec) {
    fastSignum = fastDec.fastSignum;
    fast0 = fastDec.fast0;
    fast1 = fastDec.fast1;
    fast2 = fastDec.fast2;
  ...
  protected static final String STRING_ENFORCE_PRECISION_OUT_OF_RANGE =
          "Decimal precision out of allowed range [1," + SparkDecimal.MAX_PRECISION + "]";
  protected static final String STRING_ENFORCE_SCALE_OUT_OF_RANGE =
          "Decimal scale out of allowed range [0," + SparkDecimal.MAX_SCALE + "]";
  ...
  protected boolean fastSetFromBigDecimal(
    ...
    return
            FastSparkDecimalImpl.fastSetFromBigDecimal(
  ...
  protected boolean fastSetFromBigInteger(
    ...
    return
            FastSparkDecimalImpl.fastSetFromBigInteger(
                    bigInteger, this);
  }
  ...
  protected boolean fastSetFromBytes(byte[] bytes, int offset, int length, boolean trimBlanks) {
    return
            FastSparkDecimalImpl.fastSetFromBytes(
  ...
  protected boolean fastSetFromDigitsOnlyBytesAndScale(
    ...
    return
            FastSparkDecimalImpl.fastSetFromDigitsOnlyBytesAndScale(
                    isNegative, bytes, offset, length, scale, this);
  }

  protected void fastSetFromInt(int intValue) {
    FastSparkDecimalImpl.fastSetFromInt(intValue, this);
  }
  ...
  protected boolean fastSerializationUtilsRead(
    ...
    return
            FastSparkDecimalImpl.fastSerializationUtilsRead(
  ...
  protected boolean fastSetFromBigIntegerBytesAndScale(
    ...
    return FastSparkDecimalImpl.fastSetFromBigIntegerBytesAndScale(
  ...
  protected boolean fastSerializationUtilsWrite(OutputStream outputStream,
          ...
          throws IOException {
    return
            FastSparkDecimalImpl.fastSerializationUtilsWrite(
                    outputStream,
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale,
                    scratchLongs);
  }
  ...
  protected int fastBigIntegerBytes(
    ...
    return
            FastSparkDecimalImpl.fastBigIntegerBytes(
  ...
  protected int fastBigIntegerBytesScaled(
          ...
          long[] scratchLongs, byte[] buffer) {
    return
            FastSparkDecimalImpl.fastBigIntegerBytesScaled(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    serializationScale,
                    scratchLongs, buffer);
  ...
  protected boolean fastIsByte() {
    return
            FastSparkDecimalImpl.fastIsByte(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected byte fastByteValueClip() {
    return
            FastSparkDecimalImpl.fastByteValueClip(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected boolean fastIsShort() {
    return
            FastSparkDecimalImpl.fastIsShort(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected short fastShortValueClip() {
    return
            FastSparkDecimalImpl.fastShortValueClip(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected boolean fastIsInt() {
    return
            FastSparkDecimalImpl.fastIsInt(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected int fastIntValueClip() {
    return
            FastSparkDecimalImpl.fastIntValueClip(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected boolean fastIsLong() {
    return
            FastSparkDecimalImpl.fastIsLong(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected long fastLongValueClip() {
    return
            FastSparkDecimalImpl.fastLongValueClip(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected float fastFloatValue() {
    return
            FastSparkDecimalImpl.fastFloatValue(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected double fastDoubleValue() {
    return
            FastSparkDecimalImpl.fastDoubleValue(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected BigInteger fastBigIntegerValue() {
    return
            FastSparkDecimalImpl.fastBigIntegerValue(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    fastSerializationScale);
  }
  ...
  protected BigDecimal fastBigDecimalValue() {
    return
            FastSparkDecimalImpl.fastBigDecimalValue(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale);
  }
  ...
  protected int fastCompareTo(FastSparkDecimal right) {
    return
            FastSparkDecimalImpl.fastCompareTo(
                    fastSignum, fast0, fast1, fast2,
                    fastScale,
  ...
  protected static int fastCompareTo(FastSparkDecimal left, FastSparkDecimal right) {
    return
            FastSparkDecimalImpl.fastCompareTo(
  ...
  protected boolean fastEquals(FastSparkDecimal that) {
    return
            FastSparkDecimalImpl.fastEquals(
                    fastSignum, fast0, fast1, fast2,
                    fastScale,
  ...
  protected int fastNewFasterHashCode() {
    return
            FastSparkDecimalImpl.fastNewFasterHashCode(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }

  protected int fastHashCode() {
    return
            FastSparkDecimalImpl.fastHashCode(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale);
  }
  ...
  protected int fastSqlPrecision() {
    return
            FastSparkDecimalImpl.fastSqlPrecision(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale);
  }
  ...
  protected int fastRawPrecision() {
    return
            FastSparkDecimalImpl.fastRawPrecision(
                    fastSignum, fast0, fast1, fast2);
  }
  ...
  protected boolean fastScaleByPowerOfTen(
    ...
    return
            FastSparkDecimalImpl.fastScaleByPowerOfTen(
                    fastSignum, fast0, fast1, fast2, fastIntegerDigitCount, fastScale,
                    n,
                    fastResult);
  }
  ...
  protected boolean fastRound(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastRound(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
  ...
  protected boolean isAllZeroesBelow(
          int power) {
    return
            FastSparkDecimalImpl.isAllZeroesBelow(
                    fastSignum, fast0, fast1, fast2, power);
  }

  protected boolean fastEnforcePrecisionScale(
          int maxPrecision, int maxScale) {
    if (maxPrecision <= 0 || maxPrecision > SparkDecimal.MAX_PRECISION) {
      return false;
    }
    if (maxScale < 0 || maxScale > SparkDecimal.MAX_SCALE) {
      return false;
    }
    /*
    if (!fastIsValid()) {
    ...
    */
    FastCheckPrecisionScaleStatus status =
            FastSparkDecimalImpl.fastCheckPrecisionScale(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
    ...
    switch (status) {
      ...
      {
        if (!FastSparkDecimalImpl.fastUpdatePrecisionScale(
                fastSignum, fast0, fast1, fast2,
                fastIntegerDigitCount, fastScale,
  ...
  protected boolean fastUpdatePrecisionScale(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastUpdatePrecisionScale(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    maxPrecision, maxScale, status,
                    fastResult);
  ...
  protected boolean fastSubtract(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastSubtract(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    fastRight.fastSignum, fastRight.fast0, fastRight.fast1, fastRight.fast2,
                    fastRight.fastIntegerDigitCount, fastRight.fastScale,
  ...
  protected boolean fastMultiply(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastMultiply(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    fastRight.fastSignum, fastRight.fast0, fastRight.fast1, fastRight.fast2,
                    fastRight.fastIntegerDigitCount, fastRight.fastScale,
  ...
  protected boolean fastRemainder(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastRemainder(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    fastRight.fastSignum, fastRight.fast0, fastRight.fast1, fastRight.fast2,
                    fastRight.fastIntegerDigitCount, fastRight.fastScale,
  ...
  protected boolean fastDivide(
          ...
          FastSparkDecimal fastResult) {
    return
            FastSparkDecimalImpl.fastDivide(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    fastRight.fastSignum, fastRight.fast0, fastRight.fast1, fastRight.fast2,
                    fastRight.fastIntegerDigitCount, fastRight.fastScale,
  ...
  protected String fastToString(
          byte[] scratchBuffer) {
    return
            FastSparkDecimalImpl.fastToString(
                    fastSignum, fast0, fast1, fast2,
  ...
  protected String fastToFormatString(int formatScale) {
    return
            FastSparkDecimalImpl.fastToFormatString(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    formatScale);
  }
  ...
  protected String fastToDigitsOnlyString() {
    return
            FastSparkDecimalImpl.fastToDigitsOnlyString(
                    fast0, fast1, fast2,
  ...
  protected final static int FAST_SCRATCH_BUFFER_LEN_TO_BYTES =
          1 + 1 + 1 + 2 * FastSparkDecimalImpl.MAX_DECIMAL_DIGITS;

  protected int fastToBytes(
          byte[] scratchBuffer) {
    return
            FastSparkDecimalImpl.fastToBytes(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale, -1,
                    scratchBuffer);
  }
  ...
  protected int fastToFormatBytes(
          ...
          byte[] scratchBuffer) {
    return
            FastSparkDecimalImpl.fastToFormatBytes(
                    fastSignum, fast0, fast1, fast2,
                    fastIntegerDigitCount, fastScale,
                    formatScale,
                    scratchBuffer);
  ...
  protected int fastToDigitsOnlyBytes(
          byte[] scratchBuffer) {
    return
            FastSparkDecimalImpl.fastToDigitsOnlyBytes(
                    fast0, fast1, fast2,
                    fastIntegerDigitCount,
                    scratchBuffer);
  }
  ...
  protected boolean fastIsValid() {
    return FastSparkDecimalImpl.fastIsValid(this);
  }

  protected void fastRaiseInvalidException() {
    FastSparkDecimalImpl.fastRaiseInvalidException(this);
  }

  protected void fastRaiseInvalidException(String parameters) {
    FastSparkDecimalImpl.fastRaiseInvalidException(this, parameters);
  }
}