...
public abstract class SparkBaseChar {
  protected String value;

  protected SparkBaseChar() {
  }
  ...
  public void setValue(String val, int maxLength) {
    value = SparkBaseChar.enforceMaxLength(val, maxLength);
  }

  public void setValue(SparkBaseChar val, int maxLength) {
