 ...
 */
public class SparkChar extends SparkBaseChar
        implements Comparable<SparkChar> {
  ...
  public SparkChar(String val, int len) {
    setValue(val, len);
  }

  public SparkChar(SparkChar hc, int len) {
  ...
  public void setValue(String val, int len) {
    super.setValue(SparkBaseChar.getPaddedValue(val, len), -1);
  }
  ...
  public int compareTo(SparkChar rhs) {
    if (rhs == this) {
      return 0;
    }
  ...
  public boolean equals(Object rhs) {
    ...
    return this.getStrippedValue().equals(((SparkChar) rhs).getStrippedValue());
  }
