...
import org.apache.spark.sql.service.cli.common.util.IntervalDayTimeUtils;
 ...
 */
public class SparkIntervalDayTime implements Comparable<SparkIntervalDayTime> {

  // days/hours/minutes/seconds all represented as seconds
  protected long totalSeconds;
  protected int nanos;

  public SparkIntervalDayTime() {
  }

  public SparkIntervalDayTime(int days, int hours, int minutes, int seconds, int nanos) {
    set(days, hours, minutes, seconds, nanos);
  }

  public SparkIntervalDayTime(long seconds, int nanos) {
    set(seconds, nanos);
  }

  public SparkIntervalDayTime(BigDecimal seconds) {
    set(seconds);
  }

  public SparkIntervalDayTime(SparkIntervalDayTime other) {
  ...
  public void set(SparkIntervalDayTime other) {
    set(other.getTotalSeconds(), other.getNanos());
  }

  public SparkIntervalDayTime negate() {
    return new SparkIntervalDayTime(-getTotalSeconds(), -getNanos());
  }

  @Override
  public int compareTo(SparkIntervalDayTime other) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof SparkIntervalDayTime)) {
      return false;
    }
    return 0 == compareTo((SparkIntervalDayTime) obj);
  }
   ...
   */
  public Object clone() {
    return new SparkIntervalDayTime(totalSeconds, nanos);
  }
  ...
  public static SparkIntervalDayTime valueOf(String strVal) {
    SparkIntervalDayTime result = null;
    if (strVal == null) {
    ...
    if (patternMatcher.matches()) {
      ...
      try {
        ...
        result = new SparkIntervalDayTime(days, hours, minutes, seconds, nanos);
      } catch (Exception err) {
