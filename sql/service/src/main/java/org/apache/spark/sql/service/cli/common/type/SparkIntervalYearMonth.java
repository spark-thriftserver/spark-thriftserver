...
import org.apache.spark.sql.service.cli.common.util.DateUtils;

import java.util.regex.Matcher;
import java.util.regex.Pattern;

public class SparkIntervalYearMonth implements Comparable<SparkIntervalYearMonth> {
  ...
  public SparkIntervalYearMonth() {
  }

  public SparkIntervalYearMonth(int years, int months) {
    set(years, months);
  }

  public SparkIntervalYearMonth(int totalMonths) {
    set(totalMonths);
  }

  public SparkIntervalYearMonth(SparkIntervalYearMonth hiveInterval) {
  ...
  public void set(SparkIntervalYearMonth other) {
    set(other.getTotalMonths());
  }

  public SparkIntervalYearMonth negate() {
    return new SparkIntervalYearMonth(-getTotalMonths());
  }
  ...
  @Override
  public int compareTo(SparkIntervalYearMonth other) {
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof SparkIntervalYearMonth)) {
      return false;
    }
    return 0 == compareTo((SparkIntervalYearMonth) obj);
  }
  ...
  public static SparkIntervalYearMonth valueOf(String strVal) {
    SparkIntervalYearMonth result = null;
    if (strVal == null) {
    ...
    if (patternMatcher.matches()) {
      ...
      try {
        ...
        result = new SparkIntervalYearMonth(years, months);
      } catch (Exception err) {
