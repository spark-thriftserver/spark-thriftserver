 ...
 * In case of an embedded metastore, SparkServer2 threads (foreground and background)
 ...
 * SparkServer2 uses ExecutorService for managing thread pools for foreground
