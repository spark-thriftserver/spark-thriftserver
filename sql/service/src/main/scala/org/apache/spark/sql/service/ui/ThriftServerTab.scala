...
import org.apache.spark.sql.service.ui.ThriftServerTab._
 ...
 */
private[service] class ThriftServerTab(sparkContext: SparkContext)
...
private[service] object ThriftServerTab {
