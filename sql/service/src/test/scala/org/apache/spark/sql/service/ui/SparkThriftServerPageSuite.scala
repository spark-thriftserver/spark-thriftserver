...
import org.apache.spark.sql.service.SparkThriftServer.SparkThriftServerListener
...
class ThriftServerPageSuite extends SparkFunSuite {
   ...
   */
  private def getListener: SparkThriftServerListener = {
    val listener = new SparkThriftServerListener(mock(classOf[SparkThriftServer]), new SQLConf)
